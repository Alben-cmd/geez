            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 text-center">
                    ...
                    <ul class="breadcrumb-list">
                        ...
                        <li class="breadcrumb-item active">Tailor</li>
                        <li class="breadcrumb-item active">{{ $editdata['tailorname'] }}</li>
                    </ul>
                    <!-- breadcrumb-list end -->
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="{{ $editdata['profilepicture'] }}"
                                    alt="">
                            </div>
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content">
                        <h2>{{ $editdata['tailorname'] }}</h2>
                        <div class="pricing-meta">
                            <ul>
                                <li class="old-price not-cut">{{ $editdata['tailoraddress'] }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="pro-details-sku-info pro-details-same-style  d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="mailto:{{ $editdata['emailaddress'] }}">{{ $editdata['emailaddress'] }}</a>
                                </li>
                        ...
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="{{ $editdata['phonenumber1'] }}">{{ $editdata['phonenumber1'] }}</a>
                                </li>
